...
function Table({onChangeTypeForm}: Props) {
    ...
    const handleClickToShowAddedForm = (e: React.MouseEvent) => {
        $('.admin-actors-background').css('left', '-100%')
    ...
    return (
        <div className="admin-actor-table-background">
            <div className="admin-add-actor-button">
                <button className="btn-admin btn-admin-add" onClick={handleClickToShowAddedForm}>Add</button>
            </div>
            <div className="admin-actor-table">
                <table className="admin-actor-table-title">
                    <tbody>
                        <tr>
                ...
                <div className="admin-actor-table-content">
                    <table>
                        <tbody>
                            {
                                getData()
