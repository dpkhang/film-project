...
function Table({onChangeTypeForm}: Props) {
    ...
    const handleClickToShowAddedForm = (e: React.MouseEvent) => {
        $('.admin-directors-background').css('left', '-100%')
    ...
    return (
        <div className="admin-director-table-background">
            <div className="admin-add-director-button">
                <button className="btn-admin btn-admin-add" onClick={handleClickToShowAddedForm}>Add</button>
            </div>
            <div className="admin-director-table">
                <table className="admin-director-table-title">
                    <tbody>
                        <tr>
                ...
                <div className="admin-director-table-content">
                    <table>
                        <tbody>
                            {
                                getData()
